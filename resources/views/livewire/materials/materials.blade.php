                        ...
                        <x-table.cell class="text-black" style="background: #4b455042" colspan="6">
                            <div class="text-black">
                                @unless($selectedAll)
                                    <div>
                                        <span>
                                        You have selected <strong>{{ $models->count() }}</strong> materials, do you want to select all
                                        <strong>{{ $models->total() }}</strong> materials?
                                        </span>
                                ...
                                @else
                                    <span>
                                       You are currently selecting <strong>{{ $models->total() }}</strong> materials.
                                   </span>
                                @endunless
                            </div>
                        </x-table.cell>
